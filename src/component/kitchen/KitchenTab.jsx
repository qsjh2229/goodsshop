...
const KitchenTab = () => {
   ...
   const filterHandler = (category) => {
      ...
      if (category === "all") {
         ...
         const filteredData = feedsList.filter((item) =>
   ...
   return (
      <div className='page-tab-wrap'>
         ...
         <div className='page-tab-btn'>
            <button
               type='button'
               className={`kiall ${activeTab === "all" ? "active" : ""}`}
            ...
            <button
               type='button'
               className={`cup ${activeTab === "kitchencup" ? "active" : ""}`}
               onClick={() => filterHandler("kitchencup")}
            >
               <span>컵</span>
            </button>
            <button
               type='button'
               className={`dish ${activeTab === "kitchendish" ? "active" : ""}`}
               onClick={() => filterHandler("kitchendish")}
            >
               <span>접시</span>
            </button>
            <button
               type='button'
               className={`etc ${activeTab === "kitchenetc" ? "active" : ""}`}
               onClick={() => filterHandler("kitchenetc")}
            >
               <span>그외</span>
            </button>
         </div>
